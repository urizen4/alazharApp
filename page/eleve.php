...
<section class="section-popular   white-text">
   ...
   <div class="card-title red darken-3 center">
    ...
    <tr>
        ...
        <th class="teal-text ">MONTANT<th>
        <th class="teal-text " colspan='2'>ACTION<th>
    </tr>
    <?php
     foreach ($bamba as $b) 
     {
       ...
       $samba+=$b['montant']; 
        ...
        <td><?=$b['montant']?></td>
        <td  colspan="2">
        <a href="inscription.php?edi=<?=$b['idEl']?>" class="btn green waves-effect waves-light hoverable">modifier</a>
        </td>
        <td>
        <a href="ClasseEleve.php?supp=<?=$b['idEl']?>" class="btn red darken-2 waves-effect waves-light hoverable">supprimer</a>
        </td>
        </tr>
     <?php
    }
    ...
    <tr>
       ...
       <td class=""></td>
       <td class=""></td>
       <td class="hoverable "><h4 style="font-weight:bold;"><i>TOTAL</i></h4></td>
       <td class="hoverable"><h4 style="font-weight:bold;"><?= $samba.$F?></h4></td>
    </tr>
    </table>
  </div>
</section>
